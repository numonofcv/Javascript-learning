...
const restaurant = {
    ...
    orderDelivery: function ({starterIndex=1, mainIndex=0, time='20:00', address,}) {
        console.log(`Order reseived! ${this.starterMenu[starterIndex]} and ${ this.mainMenu[mainIndex]} will be delivered to ${address} at ${time}`);
    }
};
...
restaurant.orderDelivery(
    { address: 'Via Del Scole , 21', starterIndex: 2}
);
...
// console.log(starter, mainCourse); Nasted destructuring const nasted = [
// 2,     4,     [         5, 6     ] ];  const [i, , j] =  nasted;
// console.log(i, j); const [i,, [         j, k     ] ] = nasted; console.log(i,
// j, k); Default values const [p, q, r]= [8, 9] console.log(p, q, r); const [p
